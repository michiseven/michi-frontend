...
export const DICTIONARY = {
  ja: {
    ...
    tabChatPlanner: "💬 AI対話でプラン作成",
    tabFormPlanner: "📝 フォームで直接入力",
    ...
    formAirportIcn1: "仁川国際空港 第1ターミナル (ICN T1)",
    formAirportIcn2: "仁川国際空港 第2ターミナル (ICN T2)",
    formAirportGmp: "金浦国際空港 (GMP)",
  ...
  ko: {
    ...
    tabChatPlanner: "💬 AI 대화로 플래닝",
    tabFormPlanner: "📝 폼으로 직접 입력",
    ...
    formAirportIcn1: "인천국제공항 제1여객터미널 (ICN T1)",
    formAirportIcn2: "인천국제공항 제2여객터미널 (ICN T2)",
    formAirportGmp: "김포국제공항 (GMP)",
