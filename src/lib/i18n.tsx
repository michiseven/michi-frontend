...
export const DICTIONARY = {
  ja: {
    ...
    tripBtnShare: "旅程を共有",
    tripShareUnavailable: "安全な共有リンクは準備中です。現在、この旅程は本人のみが確認できます。",
    ...
    authStartLanguageDisclosure: "対応言語：日本語・韓国語。メールでログインできます。",
    ...
    authStartExampleOneTitle: "空港到着後、荷物を預けて始める一日",
    authStartExampleOneDesc: "仁川到着・キャリーケース・ホテルチェックイン前の時間があるとき",
    authStartExampleTwoTitle: "ご両親と歩く、無理のないソウル",
    authStartExampleTwoDesc: "長い徒歩を避け、休憩を入れながら見どころと食事を選びたいとき",
    authStartExampleThreeTitle: "3時間で楽しむ、雨の日の室内コース",
    authStartExampleThreeDesc: "短い滞在時間でも、天気を気にせず室内中心で過ごしたいとき",
    authStartExamplesHint: "ログイン後は、こんな一文からすぐに相談を始められます。",
    authStartExampleAction: "このテーマで始める",
    ...
    plannerTravelConditionsHelp: "空港・宿泊先・荷物があるときだけ設定してください。あとから追加・変更できます。",
    plannerPartySize: "人数",
    plannerPeopleUnit: "人",
    plannerBudget: "予算（KRW）",
    plannerBudgetPlaceholder: "例：50000",
    plannerBudgetScope: "予算の基準",
    plannerBudgetPerPerson: "1人あたり",
    plannerBudgetTotal: "全員で合計",
    plannerCompanions: "同行者",
    plannerPace: "ペース",
    plannerNotSpecified: "指定なし",
    plannerCompanionSolo: "一人",
    plannerCompanionCouple: "カップル・二人",
    plannerCompanionFriends: "友人",
    plannerCompanionFamily: "家族",
    plannerCompanionWithChildren: "子ども連れ",
    plannerPaceRelaxed: "ゆったり",
    plannerPaceStandard: "ふつう",
    plannerPacePacked: "しっかり回る",
  ...
  ko: {
    ...
    tripBtnShare: "일정 공유",
    tripShareUnavailable: "안전한 공유 링크를 준비 중입니다. 현재 일정은 본인만 확인할 수 있어요.",
    ...
    authStartLanguageDisclosure: "지원 언어: 한국어·일본어 · 이메일로 로그인할 수 있어요.",
    ...
    authStartExampleOneTitle: "공항 도착 후 짐 맡기고 시작하는 하루",
    authStartExampleOneDesc: "인천 도착·캐리어·호텔 체크인 전 시간이 있을 때",
    authStartExampleTwoTitle: "부모님과 걷는, 무리 없는 서울 하루",
    authStartExampleTwoDesc: "긴 도보를 피하고 쉬는 시간을 넣어 볼거리와 식사를 고르고 싶을 때",
    authStartExampleThreeTitle: "3시간 안에 즐기는 비 오는 날 실내 코스",
    authStartExampleThreeDesc: "짧은 체류 시간에도 날씨를 신경 쓰지 않고 실내 중심으로 보내고 싶을 때",
    authStartExamplesHint: "로그인 후에는 이런 한 문장으로 바로 상담을 시작할 수 있어요.",
    authStartExampleAction: "이 주제로 시작하기",
    ...
    plannerTravelConditionsHelp: "공항·숙소·짐이 있을 때만 설정하세요. 나중에 추가하거나 바꿀 수 있어요.",
    plannerPartySize: "인원",
    plannerPeopleUnit: "명",
    plannerBudget: "예산 (KRW)",
    plannerBudgetPlaceholder: "예: 50000",
    plannerBudgetScope: "예산 기준",
    plannerBudgetPerPerson: "1인 기준",
    plannerBudgetTotal: "전체 합계",
    plannerCompanions: "동행",
    plannerPace: "여행 강도",
    plannerNotSpecified: "선택 안 함",
    plannerCompanionSolo: "혼자",
    plannerCompanionCouple: "커플·2인",
    plannerCompanionFriends: "친구",
    plannerCompanionFamily: "가족",
    plannerCompanionWithChildren: "아이 동반",
    plannerPaceRelaxed: "여유롭게",
    plannerPaceStandard: "보통",
    plannerPacePacked: "알차게",
